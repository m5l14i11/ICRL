#!/bin/bash
# Training script for ICRL PPO with few-shot web search learning
...
export EXPERIMENT_NAME=icrl-ppo-qwen2.5-7B
# export BASE_MODEL='Qwen/Qwen2.5-14B-Instruct'
# export EXPERIMENT_NAME=icrl-ppo-qwen2.5-14B
# export BASE_MODEL='Qwen/Qwen2.5-3B-Instruct'
# export EXPERIMENT_NAME=icrl-ppo-qwen2.5-3B
